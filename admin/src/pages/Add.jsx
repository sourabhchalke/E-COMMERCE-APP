...
const Add = ({token}) => {
  ...
  return (
    <form onSubmit={onSubmithandler} action="" className="flex flex-col w-full items-start gap-3">
      ...
      <div className="flex flex-col sm:flex-row gap-2 w-full sm:gap-8">
        ...
        <div>
          <div>
            ...
            <select className="w-full px-3 py-2" name="" id="" onChange={(e)=>setSubCategory(e.target.value)}>
      ...
      <button type="submit" className="bg-black text-white px-4 py-2 mt-4 w-28">ADD</button>
