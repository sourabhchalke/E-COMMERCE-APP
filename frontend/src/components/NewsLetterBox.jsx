...
function NewsLetterBox() {
  ...
  return (
    <div className='text-center'>
      ...
      <p className='text-gray-400 mt-3 w-2/4 mx-auto'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Et eius debitis harum at, placeat accusantium fugit officiis dolorum incidunt molestias voluptatem ducimus ipsum commodi, quos molestiae! Quos ad debitis ipsum.</p>
